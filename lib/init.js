  ...
  let initquestions = [
    {
      ...
      validate: (name) => {
        if (/^[a-zA-Z]+/.test(name)) {
          ...
          return chalk.red('Project name must be in English');
        }
      },
    },
    {
    ...
    },
    {
      ...
      choices: [
        ...
        {
          name: 'ng-simple-admin',
          value: 'ng-simple-admin',
        },
        {
          name: 'vue3-element',
          value: 'vue3-element',
...
function downloadTemplate(app, answer) {
  ...
  switch (answer.templatetype) {
    ...
    case 'vue-element-admin':
      ...
      break;
    case 'electron-vue':
      templateUrl = 'gkf442573575/electron-vue-simple';
      break;
    case 'ng-simple-admin':
      templateUrl = 'gkf442573575/ng-simple-admin#main';
      break;
    case 'vue3-element':
      templateUrl = 'gkf442573575/vue3-element-template';
      break;
    case 'vite-vue3-ts':
      templateUrl = 'gkf442573575/vite-vue-ts';
      break;
    default:
      templateUrl = 'gkf442573575/gulpsimple';
      break;
